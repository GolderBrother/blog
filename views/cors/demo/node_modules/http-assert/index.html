...
</code></pre></div><h2 id="example"><a href="#example" class="header-anchor">#</a> Example</h2> <div class="language-js extra-class"><pre class="language-js"><code><span class="token keyword">var</span> assert <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'http-assert'</span><span class="token punctuation">)</span>
<span class="token keyword">var</span> ok <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'assert'</span><span class="token punctuation">)</span>

<span class="token keyword">var</span> username <span class="token operator">=</span> <span class="token string">'foobar'</span> <span class="token comment">// username from request</span>

<span class="token keyword">try</span> <span class="token punctuation">{</span>
  <span class="token function">assert</span><span class="token punctuation">(</span>username <span class="token operator">===</span> <span class="token string">'fjodor'</span><span class="token punctuation">,</span> <span class="token number">401</span><span class="token punctuation">,</span> <span class="token string">'authentication failed'</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span>err<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token function">ok</span><span class="token punctuation">(</span>err<span class="token punctuation">.</span>status <span class="token operator">===</span> <span class="token number">401</span><span class="token punctuation">)</span>
  <span class="token function">ok</span><span class="token punctuation">(</span>err<span class="token punctuation">.</span>message <span class="token operator">===</span> <span class="token string">'authentication failed'</span><span class="token punctuation">)</span>
  <span class="token function">ok</span><span class="token punctuation">(</span>err<span class="token punctuation">.</span>expose<span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="api"><a href="#api" class="header-anchor">#</a> API</h2> <p>The API of this module is intended to be similar to the
<a href="https://nodejs.org/dist/latest/docs/api/assert.html" target="_blank" rel="noopener noreferrer">Node.js <code>assert</code> module<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>.</p> <p>Each function will throw an instance of <code>HttpError</code> from
<a href="https://www.npmjs.com/package/http-errors" target="_blank" rel="noopener noreferrer">the <code>http-errors</code> module<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>
when the assertion fails.</p> <h3 id="assert-value-status-message-properties"><a href="#assert-value-status-message-properties" class="header-anchor">#</a> assert(value, [status], [message], [properties])</h3> <p>Tests if <code>value</code> is truthy. If <code>value</code> is not truthy, an <code>HttpError</code>
is thrown that is constructed with the given <code>status</code>, <code>message</code>,
and <code>properties</code>.</p> <h3 id="assert-deepequal-a-b-status-message-properties"><a href="#assert-deepequal-a-b-status-message-properties" class="header-anchor">#</a> assert.deepEqual(a, b, [status], [message], [properties])</h3> <p>Tests for deep equality between <code>a</code> and <code>b</code>. Primitive values are
compared with the Abstract Equality Comparison (<code>==</code>). If <code>a</code> and <code>b</code>
are not equal, an <code>HttpError</code> is thrown that is constructed with the
given <code>status</code>, <code>message</code>, and <code>properties</code>.</p> <h3 id="assert-equal-a-b-status-message-properties"><a href="#assert-equal-a-b-status-message-properties" class="header-anchor">#</a> assert.equal(a, b, [status], [message], [properties])</h3> <p>Tests shallow, coercive equality between <code>a</code> and <code>b</code> using the Abstract
Equality Comparison (<code>==</code>). If <code>a</code> and <code>b</code> are not equal, an <code>HttpError</code>
is thrown that is constructed with the given <code>status</code>, <code>message</code>,
and <code>properties</code>.</p> <h3 id="assert-notdeepequal-a-b-status-message-properties"><a href="#assert-notdeepequal-a-b-status-message-properties" class="header-anchor">#</a> assert.notDeepEqual(a, b, [status], [message], [properties])</h3> <p>Tests for deep equality between <code>a</code> and <code>b</code>. Primitive values are
compared with the Abstract Equality Comparison (<code>==</code>). If <code>a</code> and <code>b</code>
are equal, an <code>HttpError</code> is thrown that is constructed with the given
<code>status</code>, <code>message</code>, and <code>properties</code>.</p> <h3 id="assert-notequal-a-b-status-message-properties"><a href="#assert-notequal-a-b-status-message-properties" class="header-anchor">#</a> assert.notEqual(a, b, [status], [message], [properties])</h3> <p>Tests shallow, coercive equality between <code>a</code> and <code>b</code> using the Abstract
Equality Comparison (<code>==</code>). If <code>a</code> and <code>b</code> are equal, an <code>HttpError</code> is
thrown that is constructed with the given <code>status</code>, <code>message</code>, and
<code>properties</code>.</p> <h3 id="assert-notstrictequal-a-b-status-message-properties"><a href="#assert-notstrictequal-a-b-status-message-properties" class="header-anchor">#</a> assert.notStrictEqual(a, b, [status], [message], [properties])</h3> <p>Tests strict equality between <code>a</code> and <code>b</code> as determined by the SameValue
Comparison (<code>===</code>). If <code>a</code> and <code>b</code> are equal, an <code>HttpError</code> is thrown
that is constructed with the given <code>status</code>, <code>message</code>, and <code>properties</code>.</p> <h3 id="assert-ok-value-status-message-properties"><a href="#assert-ok-value-status-message-properties" class="header-anchor">#</a> assert.ok(value, [status], [message], [properties])</h3> <p>Tests if <code>value</code> is truthy. If <code>value</code> is not truthy, an <code>HttpError</code>
is thrown that is constructed with the given <code>status</code>, <code>message</code>,
and <code>properties</code>.</p> <h3 id="assert-strictequal-a-b-status-message-properties"><a href="#assert-strictequal-a-b-status-message-properties" class="header-anchor">#</a> assert.strictEqual(a, b, [status], [message], [properties])</h3> <p>Tests strict equality between <code>a</code> and <code>b</code> as determined by the SameValue
Comparison (<code>===</code>). If <code>a</code> and <code>b</code> are not equal, an <code>HttpError</code>
is thrown that is constructed with the given <code>status</code>, <code>message</code>,
and <code>properties</code>.</p> <h2 id="licence"><a href="#licence" class="header-anchor">#</a> Licence</h2> <p><a href="LICENSE">MIT</a></p></div> <footer class="page-edit"><!----> <div class="last-updated"><span class="prefix">Last Updated:</span> <span class="time">2020/9/7 下午8:45:37</span></div></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/blog/assets/js/app.74817549.js" defer></script><script src="/blog/assets/js/2.f761193d.js" defer></script><script src="/blog/assets/js/81.e3dbf4d0.js" defer></script>
  </body>
</html>
