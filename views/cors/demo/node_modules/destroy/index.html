...
</code></pre></div><h3 id="destroy-stream"><a href="#destroy-stream" class="header-anchor">#</a> destroy(stream)</h3> <p>Destroy the given stream. In most cases, this is identical to a simple
<code>stream.destroy()</code> call. The rules are as follows for a given stream:</p> <ol><li>If the <code>stream</code> is an instance of <code>ReadStream</code>, then call <code>stream.destroy()</code>
...
<span class="token function">destroy</span><span class="token punctuation">(</span>stream<span class="token punctuation">)</span>
    ...
    <script src="/blog/assets/js/app.74817549.js" defer></script><script src="/blog/assets/js/2.f761193d.js" defer></script><script src="/blog/assets/js/72.69c7c32d.js" defer></script>
  </body>
</html>
